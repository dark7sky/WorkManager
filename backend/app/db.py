...
def init_db():
    with connection() as c:
        ...
        CREATE TABLE IF NOT EXISTS todo_attachments(id INTEGER PRIMARY KEY AUTOINCREMENT,user_id TEXT NOT NULL,todo_id INTEGER NOT NULL,filename TEXT NOT NULL,content_type TEXT NOT NULL,size_bytes INTEGER NOT NULL,data_base64 TEXT NOT NULL,created_at TEXT NOT NULL,FOREIGN KEY(user_id) REFERENCES users(id) ON DELETE CASCADE,FOREIGN KEY(todo_id) REFERENCES todos(id) ON DELETE CASCADE);
        CREATE TABLE IF NOT EXISTS work_log_attachments(id INTEGER PRIMARY KEY AUTOINCREMENT,user_id TEXT NOT NULL,work_log_id INTEGER NOT NULL,filename TEXT NOT NULL,content_type TEXT NOT NULL,size_bytes INTEGER NOT NULL,data_base64 TEXT NOT NULL,created_at TEXT NOT NULL,FOREIGN KEY(user_id) REFERENCES users(id) ON DELETE CASCADE,FOREIGN KEY(work_log_id) REFERENCES work_logs(id) ON DELETE CASCADE);
        """)
        ...
        _add_column(c, "work_logs", "public_token_view_count", "INTEGER NOT NULL DEFAULT 0")
        _add_column(c, "work_logs", "public_token_last_viewed_at", "TEXT")
        ...
        for name, definition in {
            ...
            "public_token_view_count": "INTEGER NOT NULL DEFAULT 0", "public_token_last_viewed_at": "TEXT",
        }.items():
        ...
        for name, definition in {"recurrence_rule": "TEXT", "recurrence_spawned_at": "TEXT", "priority": "TEXT NOT NULL DEFAULT 'normal'", "link_url": "TEXT", "recurrence_end_date": "TEXT", "memo": "TEXT",
                                  ...
                                  "public_token_expires_at": "TEXT", "recurrence_group_id": "TEXT",
                                  "public_token_password_hash": "TEXT",
                                  "public_token_view_count": "INTEGER NOT NULL DEFAULT 0", "public_token_last_viewed_at": "TEXT"}.items():
        ...
        c.execute("CREATE INDEX IF NOT EXISTS idx_todo_attachments_todo ON todo_attachments(user_id,todo_id,created_at)")
        c.execute("CREATE INDEX IF NOT EXISTS idx_work_log_attachments_log ON work_log_attachments(user_id,work_log_id,created_at)")
