...
export default function Settings({ theme, setTheme, teamMembers = [], setTeamMembers, notify, onDataChanged, canInstall, onInstall, notificationPermission, onEnableNotifications }) {
