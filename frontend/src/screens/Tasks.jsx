...
import { BellRing, CalendarRange, CheckCircle2, Download, FileText, Flag, GitPullRequestArrow, RotateCcw, Search, ShieldCheck, SlidersHorizontal } from 'lucide-react'
...
import { filterTasks, isTaskOverdue, summarizeBlockedTasks, summarizeDueReminders, taskBlockingDependencies } from '../taskFilters'
...
export default function Tasks({tasks,onNew,onEdit,onProgress,onApprove}){
  const [query,setQuery]=useState(''),[status,setStatus]=useState('active'),[selectedTags,setSelectedTags]=useState([]),[priority,setPriority]=useState('all'),[draft,setDraft]=useState({})
