...
export default function Today(props) {
  const {
    ...
    onAddLog, onUpdateLog, onDeleteLog, onDuplicateLog, onPromoteLog, onImportLogs, onToggleTask, goAI, onViewHistoryTodo, onViewHistoryLog,
