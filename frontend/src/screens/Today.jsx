...
export default function Today(props) {
  const {
    ...
    onBulkDeleteLog, onBulkAddTagLog, onBulkPostponeLog, onBulkPriorityLog, onBulkColorLog, onBulkBillableLog, onBulkDuplicateLog, onBulkArchiveLog, onBulkPromoteLog, focusTag, focusTodoId, notify, onOpenTask,
  } = props
