...
export default function Calendar({ events, tasks = [], loading, onOpenTask, onCreate, onUpdate, onDelete, onBulkDelete, onBulkAddTag, onBulkPostpone, onBulkPriority, onBulkColor, onBulkDuplicate, onArchive, onPromoteEvent, onDataChanged, onViewHistory, focusTag, notify }) {
