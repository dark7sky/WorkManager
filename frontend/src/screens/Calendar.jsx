...
export default function Calendar({ events, tasks = [], onOpenTask, onCreate, onUpdate, onDelete, onBulkDelete, onBulkAddTag, onBulkPostpone, onBulkPriority, onBulkColor, onBulkDuplicate, onArchive, onDataChanged, onViewHistory, notify }) {
