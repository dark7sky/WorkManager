...
import { AlertTriangle, CheckSquare, ChevronLeft, ChevronRight, Copy, Download, ExternalLink, FileText, Flag, MapPin, Paperclip, Plus, Search, Star, Tag, Upload } from 'lucide-react'
...
export default function Calendar({ events, tasks = [], onOpenTask, onCreate, onUpdate, onDelete, onBulkDelete, onBulkAddTag, onDataChanged, notify }) {
