...
export const changelogUpdates = [
  ...
  {
    id: '2026-07-10-live-feedback-batch',
    timestamp: '2026-07-10T12:50:15+09:00',
    description: '실사용 중 접수된 개선 요청을 반영했습니다: 일정 종료시간이 시작시간+1시간으로 자동 맞춰지고(수동 변경은 유지됨), 날짜 셀 안 일정이 시간순으로 정렬되고, AI 설정에서 제공자를 바꾸면 모델 목록이 바로 갱신되고, 모바일 홈 화면 자동 회전을 껐고, 모바일 하단 메뉴에서 가려져 있던 설정 메뉴가 다시 보이도록 감사 로그를 설정 화면 안으로 옮겼습니다.',
  },
  {
