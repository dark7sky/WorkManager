...
export const api = {
  ...
  shareEvent: (id,expiresInDays) => request(`/events/${id}/share${expiresInDays?`?expires_in_days=${expiresInDays}`:''}`,{method:'POST'}), unshareEvent: id => request(`/events/${id}/share`,{method:'DELETE'}),
  ...
  shareLog: (id,expiresInDays) => request(`/work_logs/${id}/share${expiresInDays?`?expires_in_days=${expiresInDays}`:''}`,{method:'POST'}), unshareLog: id => request(`/work_logs/${id}/share`,{method:'DELETE'}),
